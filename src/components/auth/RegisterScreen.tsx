...
export function RegisterScreen({ onRegister, onGoogleLogin, onSwitchToLogin }: RegisterScreenProps) {
    ...
    <div className="min-h-screen bg-page flex items-center justify-center p-8">
      ...
      >
        ...
        <p className="text-sm text-text-muted text-center mb-10">
          Set up Kith and start achieving your goals
        </p>
        ...
        <p className="text-xs text-text-muted text-center mt-8">
          ...
          <button onClick={onSwitchToLogin} className="text-olive hover:text-olive-hover cursor-pointer font-medium">
            Sign in
          </button>
        </p>
      </motion.div>
