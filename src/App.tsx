...
const DEMO_BUBBLES: Array<{ type: BubbleType; label: string; message: string; primary: string; secondary: string }> = [
  {
    type: 'hook',
    label: 'goal check',
    message: 'Freelancing is your #1 goal but you haven\'t touched it since 7 PM. Swap tonight\'s slot?',
    primary: 'Swap it',
    secondary: 'Later',
  },
  {
    type: 'connection',
    label: 'nice progress',
    message: 'That\'s 3 DM batches done this week. 2 more and you hit your outreach target.',
    primary: 'Show goals',
    secondary: 'Dismiss',
  },
  {
    type: 'fetch',
    label: 'heads up',
    message: 'Startup MVP is behind pace. At 6h/week it ships in August, not March. Add more time?',
    primary: 'Reschedule',
    secondary: 'Keep it',
  },
  {
    type: 'direction',
    label: 'just checking',
    message: 'You\'ve spent 3 hours on LinkedIn this week but only 1 on freelancing. Intentional?',
    primary: 'Fix it',
    secondary: 'It\'s fine',
  },
]
